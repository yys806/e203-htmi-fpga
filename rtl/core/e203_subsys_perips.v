...
module e203_subsys_perips(
  ...
  wire                     my_periph_icb_cmd_valid;
  wire                     my_periph_icb_cmd_ready;
  wire [32-1:0]            my_periph_icb_cmd_addr; 
  wire                     my_periph_icb_cmd_read; 
  wire [32-1:0]            my_periph_icb_cmd_wdata;
  ...
  //  * QSPI0     
    ...
    .o5_icb_cmd_valid  (my_periph_icb_cmd_valid),
    .o5_icb_cmd_ready  (my_periph_icb_cmd_ready),
    .o5_icb_cmd_addr   (my_periph_icb_cmd_addr ),
    .o5_icb_cmd_read   (my_periph_icb_cmd_read ),
    .o5_icb_cmd_wdata  (my_periph_icb_cmd_wdata),
    .o5_icb_cmd_wmask  (),
    .o5_icb_cmd_lock   (),
    .o5_icb_cmd_excl   (),
    .o5_icb_cmd_size   (),
    ...
    .o5_icb_rsp_valid  (my_periph_icb_rsp_valid),
    .o5_icb_rsp_ready  (my_periph_icb_rsp_ready),
    .o5_icb_rsp_err    (1'b0  ),
    .o5_icb_rsp_excl_ok(1'b0  ),
    .o5_icb_rsp_rdata  (my_periph_icb_rsp_rdata),
...
// terminal peripheral (ICB slot O5)
fpga_terminal_icb u_my_periph_top(
    .clk             (clk),
    .rst_n           (rst_n),
